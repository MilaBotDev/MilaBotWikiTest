---
title: "10. Restrictions, reports, and leaving"
slug: restrictions-reports-and-leaving
order: 2
---
...
You may also contact support to request deletion or an ongoing privacy restriction. An active level-1 restriction prevents commands and controls that save data in the Bot's database. An active level-2 restriction also prevents other command and control use and interactions selecting or mentioning you through the Bot. Affected features become unavailable while the restriction is enforced. Existing data is removed separately by staff; attempting another command does not lift an active restriction. See the [Privacy Policy]({{ '/privacy/' | relative_url }}) for scope and limitations.
