...
We do not sell or rent personal information, share it for advertising, or use Discord message content to train AI models.

Information is disclosed as needed to:

- **Discord**, which delivers interactions, hosts messages and attachments, and performs server actions under its [Privacy Policy](https://discord.com/privacy).
- **Cloudflare**, which hosts the Worker and persistent database and may process operational metadata under its [Privacy Policy](https://www.cloudflare.com/privacypolicy/).
- **GitHub Pages and media hosts**, which serve dictionary files, images, and GIFs. A dictionary lookup requests a URL containing the normalized search term. A media request reveals the requested URL to its host; submitted URLs may themselves contain identifiers. The dictionary request does not intentionally attach your Discord user ID.
